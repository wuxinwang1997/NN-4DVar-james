...
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=2.0 --obs_partial=0.75 --dim=400 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=4.0 --obs_partial=0.75 --dim=400 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=6.0 --obs_partial=0.75 --dim=400 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=8.0 --obs_partial=0.75 --dim=400 --years=0.5
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.2 --obs_partial=0.75 --dim=400
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.4 --obs_partial=0.75 --dim=400
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.6 --obs_partial=0.75 --dim=400
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.8 --obs_partial=0.75 --dim=400
