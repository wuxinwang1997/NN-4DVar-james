...
python src/evaluation/eval_obserr.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=LETKF --da_N=20 --da_Inf=1.02 --da_rot=False --da_loc_rad=10  --obs_partial=0.75 --normalize=True --pred_len=4 --obserr=1.5 
python src/evaluation/eval_obserr.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=LETKF --da_N=20 --da_Inf=1.02 --da_rot=False --da_loc_rad=10  --obs_partial=0.75 --normalize=True --pred_len=4 --obserr=2.0
python src/evaluation/eval_obserr.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=LETKF --da_N=20 --da_Inf=1.02 --da_rot=False --da_loc_rad=10  --obs_partial=0.75 --normalize=True --pred_len=4 --obserr=2.5
python src/evaluation/eval_obserr.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=LETKF --da_N=20 --da_Inf=1.02 --da_rot=False --da_loc_rad=10  --obs_partial=0.75 --normalize=True --pred_len=4 --obserr=3.0
