...
python src/evaluation/eval_pred.py --da_model=4dvarnet_ae --mlda_name=4DVarNet --da_method=My4DVar --da_N=20 --da_Bx=0.1 --da_Inf=1.0 --da_rot=False  --obs_partial=1.0 --normalize=False --pred_len=4 --da_Lag=1 --years=1 --dim=100
# python src/evaluation/eval_pred.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=My4DVar --da_N=20 --da_Bx=0.1 --da_Inf=1.0 --da_rot=False  --obs_partial=1.0 --normalize=True --pred_len=4 --da_Lag=1 --years=1 --dim=100

python src/evaluation/eval_pred.py --da_model=4dvarnet_ae --mlda_name=4DVarNet --da_method=My4DVar --da_N=20 --da_Bx=0.1 --da_Inf=1.0 --da_rot=False  --obs_partial=0.75 --normalize=False --pred_len=4 --da_Lag=1 --years=1 --dim=100
# python src/evaluation/eval_pred.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=My4DVar --da_N=20 --da_Bx=0.1 --da_Inf=1.0 --da_rot=False --obs_partial=0.75 --normalize=True --pred_len=4 --da_Lag=1 --years=1 --dim=100
