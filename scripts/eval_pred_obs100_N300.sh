...
python src/evaluation/eval_pred.py --da_model=4dvarnet_ae --mlda_name=4DVarNet --da_method=My4DVar --da_N=20 --da_Bx=0.2 --da_Inf=1.0 --da_rot=False  --obs_partial=1.0 --normalize=False --da_Lag=1 --pred_len=4 --years=1 --dim=300
# python src/evaluation/eval_pred.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=My4DVar --da_N=20 --da_Bx=0.2 --da_Inf=1.0 --da_rot=False  --obs_partial=1.0 --normalize=True --da_Lag=1 --pred_len=4 --years=1 --dim=300

python src/evaluation/eval_pred.py --da_model=4dvarnet_ae --mlda_name=4DVarNet --da_method=My4DVar --da_N=20 --da_Bx=0.6 --da_Inf=1.0 --da_rot=False  --obs_partial=0.75 --normalize=False --da_Lag=1 --pred_len=4 --years=1 --dim=300
# python src/evaluation/eval_pred.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=My4DVar --da_N=20 --da_Bx=0.6 --da_Inf=1.0 --da_rot=False --obs_partial=0.75 --normalize=True --da_Lag=1 --pred_len=4 --years=1 --dim=300
