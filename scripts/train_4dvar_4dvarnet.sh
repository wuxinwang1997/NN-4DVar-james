...
python src/train.py model=fdvarnet_ae data=L96_4dvarnet_4dvar_N40_partial1.0 data.obs_num=5 data.normalize=False test=False data.pred_len=1 data.da_method=My4DVar
...
python src/train.py model=seresnet_v1 data=L96_4dvar_N40_partial1.0 data.normalize=True data.pred_len=4 data.obs_num=5 data.da_method=My4DVar
