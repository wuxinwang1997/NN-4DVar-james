...
python src/data_factory/generate_dataset_L96.py --da_method='My4DVar' --da_Lag=1 --da_Bx=4.0 --obs_partial=0.75 --dim=500

python src/train.py model=fdvarnet_ae data=L96_4dvarnet_4dvar_N500_partial0.75 data.obs_num=5 data.normalize=False test=False data.pred_len=1 data.da_method=My4DVar model.shapeData=500
...
python src/train.py model=seresnet_v2 data=L96_4dvar_N500_partial0.75 data.normalize=True data.pred_len=4 data.obs_num=5 data.da_method=My4DVar
