...
python src/evaluation/eval_pred.py --da_model=4dvarnet_ae --mlda_name=4DVarNet --da_method=EnKF --da_N=20 --da_Inf=1.02 --da_rot=True  --obs_partial=1.0 --normalize=False --pred_len=0 --years=1
python src/evaluation/eval_pred.py --da_model=seresnet_v2 --mlda_name=NN4DVar --da_method=EnKF --da_N=20 --da_Inf=1.02 --da_rot=True  --obs_partial=1.0 --normalize=True --pred_len=4 --years=1
