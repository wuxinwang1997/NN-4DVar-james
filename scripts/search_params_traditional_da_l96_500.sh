...
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=2.0 --obs_partial=0.75 --dim=500 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=4.0 --obs_partial=0.75 --dim=500 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=6.0 --obs_partial=0.75 --dim=500 --years=0.5
python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=8.0 --obs_partial=0.75 --dim=500 --years=0.5
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.2 --obs_partial=0.75 --dim=500
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.4 --obs_partial=0.75 --dim=500
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.6 --obs_partial=0.75 --dim=500
# python src/evaluation/search_param_traditional_da.py --da_method='My4DVar' --da_Lag=1 --da_Bx=1.8 --obs_partial=0.75 --dim=500

# python src/evaluation/search_param_traditional_da.py --da_method='EnKF' --da_N=20 --da_Inf=1.0 --da_rot=True  --obs_partial=0.75
# python src/evaluation/search_param_traditional_da.py --da_method='EnKF' --da_N=20 --da_Inf=1.0 --da_rot=False --obs_partial=0.75
